...
--     sum(case when watch_pv>0 then 1 else 0 end) as "预约播放人数",
...
with t0 as (
    ...
    t0_1.d_date,
    t0_1.vid,
    count(distinct t0_2.uid) as total_watch_uv
    from t0 t0_1 left join t0 t0_2 on  t0_1.d_date>=t0_2.d_date and t0_1.vid=t0_2.vid
    group by t0_1.d_date,t0_1.vid
), t3 as (
    --
    select
    tmp_t.d_date  as d_date     ,
