...
WITH tmp_uid_date_info as (
    ...
    on t.order_date =t2.data_date and t.area = t2.area and t.country_name = t2.country_name and t.user_type = t2.user_type;
-----------------------------------------------------------
-- 注入cal02
-----------------------------------------------------------
...
select
    ...
    coalesce("累计看剧时长任务赠币",0) as "累计看剧任务赠币",
