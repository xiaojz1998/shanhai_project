...
truncate table tmp.dw_operate_schedule_tmp01 ;
insert into tmp.dw_operate_schedule_tmp01
-- 脚本
-- 维度：日期，国家，语言  d_date country_code country_name area lang lang_name
-- 新增用户信息，用于补全国家和语言
...
;
	...
	insert into public.dw_operate_schedule select * from tmp.dw_operate_schedule_tmp01;
